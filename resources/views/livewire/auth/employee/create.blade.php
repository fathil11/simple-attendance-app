<x-jet-dialog-modal wire:model="showCreateEmployeeModal">
    <x-slot name="title">
        {{ __('Tambah Karyawan') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="mt-8">
            ...
            <div class="mt-4 col-span-6 sm:col-span-4">
                <x-jet-label for="code" value="{{ __('Nomor Induk') }}" />
                <x-jet-input id="code" type="text" class="mt-1 block w-full" wire:model.defer="employee.code"/>
                <x-jet-input-error for="employee.code" class="mt-2" />
            </div>
    ...
    <x-slot name="footer">
        <x-jet-secondary-button wire:click="$set('showCreateEmployeeModal', false)" wire:loading.attr="disabled">
            {{ __('Batal') }}
        </x-jet-secondary-button>

        <x-jet-button class="ml-3" wire:click="storeEmployee()" wire:loading.attr="disabled">
            {{ __('Simpan Karyawan') }}
        </x-jet-button>
    </x-slot>
</x-jet-dialog-modal>
